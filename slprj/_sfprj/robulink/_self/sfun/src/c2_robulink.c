...
static const char * c2_debug_family_names[8] = { "d", "k", "nargin", "nargout",
  "v", "omega", "vl", "vr" };
...
static void sf_c2_robulink(SFc2_robulinkInstanceStruct *chartInstance)
{
  ...
  _SFD_DATA_RANGE_CHECK(*c2_b_vl, 0U);
  _SFD_DATA_RANGE_CHECK(*c2_b_vr, 1U);
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_nargout, 3U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c2_v, 4U, c2_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c2_omega, 5U, c2_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_vl, 6U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_vr, 7U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  CV_EML_FCN(0, 0);
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(894382586U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(2218774599U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(2121283880U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(960216439U);
}
...
mxArray *sf_c2_robulink_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("tF47ty8TmaYBLlsJHpZIVF");
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
...

        {
          ...
          c2_vr = (real_T *)ssGetOutputPortSignal(chartInstance->S, 2);
          c2_vl = (real_T *)ssGetOutputPortSignal(chartInstance->S, 1);
          _SFD_SET_DATA_VALUE_PTR(0U, c2_vl);
          _SFD_SET_DATA_VALUE_PTR(1U, c2_vr);
...
static void mdlSetWorkWidths_c2_robulink(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(1265444933U));
  ssSetChecksum1(S,(399326669U));
  ssSetChecksum2(S,(4156128029U));
  ssSetChecksum3(S,(3292788489U));
